    ...
    if message.content.startswith(prefix):
        ...
        if message.content.startswith('Cn!stopwatch '):
            ...
            if arg == 'now':
                ...
                await message.channel.send(embed=discord.Embed(title="Error",description="Cn!stopwatch <start,now>",colour=0x7ED6DE))
